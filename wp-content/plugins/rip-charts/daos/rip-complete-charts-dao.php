...
class Rip_Complete_Charts_Dao extends \Rip_General\Classes\Rip_Abstract_Dao {
     ...
     * @return array
     */
    public function get_complete_charts_number_of_pages($slug = null, $count = null) {
        $wpdb = $this->get_db();
        ...
        if ($count === null) {
            ...
            $number_of_pages = ceil($results['total_items'] / (int) $count);
        }
    ...
    public function get_all_complete_charts($count = null, $page = null) {
        ...
        if ($page) {
            $offset = ($page * (int) $count) - (int) $count;
            $sql .= ' LIMIT ' . $offset . ', ' . (int) $count;
        } else {
            $sql .= ' LIMIT ' . (int) $count;
        }
     ...
     * @return array
     */
    public function get_all_complete_charts_by_chart_type($slug, $count = null, $page = null) {
        $wpdb = $this->get_db();
